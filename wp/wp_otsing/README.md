...
<img width=55% src="Ekraanipilt-wp-otsing-lemmad-paring-1.png">

* Vali ```Kuvame normaliseeritud päringut```
* Kliki ```Otsing``` nuppu

<img width=55% src="Ekraanipilt-wp-otsing-lemmad-paring-2.png">
...
<img width=55% src="Ekraanipilt-wp-otsing-lemmad-otsing-1.png">

Kliki ```Otsing``` nuppu.

<img width=55% src="Ekraanipilt-wp-otsing-lemmad-otsing-2a.png">

Ruumi kokkuhoiu huvides on keskmine osa pildist äralõigatud.

<img width=55% src="Ekraanipilt-wp-otsing-lemmad-otsing-2b.png">
...
<img width=55% src="Ekraanipilt-wp-otsing-lemmad-otsing-3.png">

Vali ```Lisame tekstist leitud otsisõnedele detailsema info```
Kliki ```Otsing``` nuppu.

<img width=55% src="Ekraanipilt-wp-otsing-lemmad-otsing-3a.png">

Ruumi kokkuhoiu huvides on keskmine osa pildist äralõigatud.

<img width=55% src="Ekraanipilt-wp-otsing-lemmad-otsing-3b.png">

#### 1.2.4 [Tekstikorpuse kuvamine](https://smart-search.tartunlp.ai/wp/otsing-lemmad/texts)

<img width=55% src="Ekraanipilt-wp-otsing-lemmad-texts-1.png">

* Vali tekst vaatamiseks.
* Kliki ```Kuva``` nuppu.

<img width=55% src="Ekraanipilt-wp-otsing-lemmad-texts-2.png">

#### 1.2.5 [Versiooni-info kuvamine](https://smart-search.tartunlp.ai/wp/otsing-lemmad/version)

<img width=55% src="Ekraanipilt-wp-otsing-lemmad-version.png">
...
<img width=55% src="Ekraanipilt-wp-otsing-soned-paring-1.png">

* Vali ```Kuvame normaliseeritud päringut```
* Kliki ```Otsing``` nuppu

<img width=55% src="Ekraanipilt-wp-otsing-soned-paring-2a.png">
...
<img width=55% src="Ekraanipilt-wp-otsing-soned-otsing-1a.png">

Kliki ```Otsing``` nuppu.

<img width=55% src="Ekraanipilt-wp-otsing-soned-otsing-1b.png">
...
<img width=55% src="Ekraanipilt-wp-otsing-soned-otsing-2a.png">

* Vali ```Lisame tekstist leitud otsisõnedele detailsema info```
* Kliki ```Otsing``` nuppu.

<img width=55% src="Ekraanipilt-wp-otsing-soned-otsing-2b.png">

Ruumi kokkuhoiu huvides on pildilt keskmine osa äralõigatud.

<img width=55% src="Ekraanipilt-wp-otsing-soned-otsing-2c.png">

#### 2.2.4 [Tekstikorpuse kuvamine](https://smart-search.tartunlp.ai/wp/otsing-soned/texts)

---

<img width=55% src="Ekraanipilt-wp-otsing-soned-texts-1.png">

* Vali tekst vaatamiseks.
* Kliki ```Kuva``` nuppu.

<img width=55% src="Ekraanipilt-wp-otsing-soned-texts-2.png">

* [Versiooni-info kuvamine](https://smart-search.tartunlp.ai/wp/otsing-soned/version)

<img width=55% src="Ekraanipilt-wp-otsing-soned-version-1.png">
